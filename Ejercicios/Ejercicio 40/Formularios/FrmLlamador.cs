        ...
        private void btnLlamar_Click(object sender, EventArgs e)
        {
            if (Regex.IsMatch(this.txtNroDestino.Text, "^#?[0-9]{4}-[0-9]{4}$") && Regex.IsMatch(this.txtNroOrigen.Text, "^[0-9]{4}-[0-9]{4}$"))
            {
                if (Regex.IsMatch(this.txtNroDestino.Text, "^#"))
                {
                    ...
                    Provincial nuevaLlamada = new Provincial(this.txtNroOrigen.Text, franjas, new Random().Next(1, 50), this.txtNroDestino.Text);
                ...
                else
                {
                    ...
                    Local nuevaLlamada = new Local(this.txtNroOrigen.Text, new Random().Next(1, 50), this.txtNroDestino.Text, costo);
                    this.centralTelefonica += nuevaLlamada;
                }
            }
            else
