...
namespace Uño.Mauricio._2C
{
    public partial class View : Form
    {
        ...
        private void lstAlumnosCreados_KeyDown(object sender, KeyEventArgs e)
        {
            if (lstAlumnosCreados.SelectedIndex != -1) 
            {
                Alumno estudiante = (Alumno)lstAlumnosCreados.Items[lstAlumnosCreados.SelectedIndex];
                MessageBox.Show(estudiante.Informacion, "Informacion", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }           
        }
    }
}